...
begin
  ...
  Form11.IDServicoAvaliar := IDServico; // ← passe o ID certo!
...
begin
  ...
  // volta para tela de serviços normal
end;
...
begin
  ...
  begin
    ...
    // ou o campo que você usa pra identificar o serviço
  ...
  Mensagem := 'Olá! Gostaria de mais informações sobre o serviço: ' +
    LabelTitulodobanco.Caption;
